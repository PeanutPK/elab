...
def create_account(num, type, name, init_balance):
    """
    This function created a dictionary contains of number, type,
    name, balance of the account and detect whether the account is
...
def delete_account(num):
    """
    Delete the existing account from the dictionary.
    :param num:
    :return:
    """
    index = search_account_db(num)
...
def search_account_db(num):
    """
    Search whether the account existed or not. If not exist return value -1
    :param num:
    :return:
    """
...
def deposit(account_num, amount):
    """
    Deposit money to the account if it exists.
    :param account_num:
    :param amount:
    :return:
    """
